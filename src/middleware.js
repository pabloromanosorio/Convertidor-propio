...
async function pdfToImages(pdfPath, pageRange) {
    ...
    try {
        // Convert ALL pages first (easiest for pdftoppm)
        // Optimization: If pageRange is simple "1-5", we could use -f 1 -l 5, but filtering is safer for "1,3,5"
    ...
    // Parse Page Numbers from filenames (e.g. "doc-1.png" -> 1)
    // pdftoppm format is prefix-1.png, prefix-2.png (no zero padding usually)
    // Warning: if prefix contains hyphens, be careful. strict regex needed.
