return [
    ...
    // 5. List Header (Underlined)
    new Paragraph({
        indent: { left: 720 }, // Indent to match visual hierarchy
        children: [
            new TextRun({
    ...
    // 6. The List Items
    // Note: Using bullet configuration as strictly requested by documentation rules
    new Paragraph({
    ...
    new Paragraph({
        ...
        children: [
            new TextRun({
                text: "[IMAGE placeholder]", // Represents the DS signature box
                font: "Arial",
                size: 22,
                color: "000000",
            }),
